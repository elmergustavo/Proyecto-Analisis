...
<head>
	...
	<title>Restaurarnte Calle Real</title>
	...
	<div class="d-flex align-items-stretch">
		...
		<nav id="sidebar">
			...
			<div class="sidebar-header d-flex align-items-center">
				<div class="avatar"><img src="img/login.jpg" alt="..." class="img-fluid rounded-circle"></div>
				<div class="title">
			...
			<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
				...
				<li class="nav-item">
					...
					<div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
						<div class="bg-white py-2 collapse-inner rounded">
							<a class="collapse-item" href="registro_producto.php">Nuevo platillo</a>
							<a class="collapse-item" href="lista_productos.php">Platillos</a>
						</div>
					</div>
				</li>
